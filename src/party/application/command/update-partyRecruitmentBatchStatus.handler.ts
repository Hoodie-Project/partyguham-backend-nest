...
import { UpdatePartyRecruitmentBatchStatusCommand } from './update-partyRecruitmentBatchStatus.comand';
import { StatusEnum } from 'src/common/entity/baseEntity';

@Injectable()
@CommandHandler(UpdatePartyRecruitmentBatchStatusCommand)
export class UpdatePartyRecruitmentBatchStatusHandler
  implements ICommandHandler<UpdatePartyRecruitmentBatchStatusCommand>
{
  constructor(
  ...
  async execute(command: UpdatePartyRecruitmentBatchStatusCommand) {
    ...
    const partyRecruitment = await this.partyRecruitmentRepository.updateRecruitmentStatusBatch(
      partyRecruitmentIds,
